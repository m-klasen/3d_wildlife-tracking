...
import mailpy
from bbox_util import boxoverlap, box3doverlap
...
class trackingEvaluation(object):
    ...
    def __init__(self, t_sha, gt_path="./evaluation", max_truncation = 0, min_height = 25, max_occlusion = 2, mail=None, cls="Misc", eval_3diou=True, eval_2diou=False):
        ...
        self.t_sha             = t_sha
        self.t_path            = os.path.join(t_sha, "data")
    ...
    def loadGroundtruth(self):
        ...
        try:
            print(f"Loading ground truths from {self.gt_path}")
    ...
    def loadTracker(self):
        ...
        try:
            print(f"Loading tracking data from {self.t_path}")
...
class stat:
    ...
    def plot(self):
        save_dir = os.path.join("", self.t_sha)
